...
public class MapReduce {
	...
	public static interface Mapper { void map(String key, String value, MapReduce mr); }
	public static interface Reducer { void reduce(String key, Cons value, MapReduce mr); }
	...
	public void collect_map(String key, Cons value) {
		// System.out.println("   coll key = " + key + "  val = " +
		// value.toString());
		Cons ptrs = (Cons) themap.get(key);
		// if ( ptrs != null ) System.out.println("       ptrs = " +
		// ptrs.toString());
